    ...
    */
    ...
    const handleSignupClick = async () =>
    {
        ...
        catch (err : any)
        {
            ...
            if (!IsValidEmail(email)) setErrorMessage("Email is invalid.");
        }
        ...
        <form className="mt-8 space-y-4 m-3">
            ...
            <div className="flex justify-center mt-7">
                <button
                    ...
                    disabled={isLoading}
                    className={`text-sm w-full py-3 px-4 text-sm tracking-wide rounded-lg ${isLoading ? 'bg-gray-500' : 'bg-blue-600'} hover:bg-blue-700 focus:outline-none dark:bg-blue-700 dark:hover:bg-blue-800 no-style`} >
