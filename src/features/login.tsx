            ...
            <form className="mt-8 space-y-4 m-3">
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="username" type="text" className="w-full text-sm border px-4 py-3 rounded-md text-base" placeholder="Enter user name" />
              ...
              <div>
                <label className="text-sm mb-2 block text-center">Password</label>
                <div className="relative flex items-center">
              ...
              <p className=" text-sm !mt-8 text-center">Don't have an account? <a href="javascript:void(0);" className="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a></p>
            </form>
        </>
    );
}